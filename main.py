...
if args.dataset == "vimeo90K_septuplet":
    ...
    train_loader = get_loader(args.data_root, args.batch_size, shuffle=True, num_workers=args.num_workers, is_training=True, inter_frames=args.n_outputs, n_inputs=args.nbr_frame)
